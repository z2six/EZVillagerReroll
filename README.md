...
Welcome to **Villager Overhaul**. This mod adds a bunch of QoL features to trading and farming, as well as completely new villager combat mechanics.

Everything is _balanced_ to try and make sure it's not overpowered. The methodology is simple:

*   Villagers are "dumb" NPC's, and this mod intends to mostly keep it that way, but even "dumb" villagers could be so much more useful than they currently are. Vanilla truly mistreats the Villager faction 🥲
...
Trading features consume emeralds. Everything is fully configurable, of course.
