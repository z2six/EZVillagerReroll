...
public final class VillagerAccessGate {
     ...
     */
    public static Result check(Villager vill, ServerPlayer player) {
        try {
    ...
    public static boolean canUseControls(Villager vill, ServerPlayer player) {
        return check(vill, player) == Result.OWNER;
    }

    /** Info screen is always allowed per your spec. */
    public static boolean canViewInfo(Villager vill, ServerPlayer player) {
