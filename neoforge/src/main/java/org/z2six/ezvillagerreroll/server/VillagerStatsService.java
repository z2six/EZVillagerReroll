// MainFile: neoforge/src/main/java/org/z2six/ezvillagerreroll/server/VillagerStatsService.java
...
public final class VillagerStatsService {
    ...
    public static void ensureStats(Entity e) {
        try {
            ...
            EZVillagerReroll.LOG().warn("[EZVR] VillagerStatsService.ensureStats failed (soft): {}", t.toString());
        }
    }
